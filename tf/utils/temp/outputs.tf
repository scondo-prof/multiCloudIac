output "AGRAMVKUP_RestApiArn" {
  value = module.restApi.restApiArn
}

output "AGRAMVKUP_RestApiExecutionArn" {
  value = module.restApi.restApiExecutionArn
}

output "AGRAMVKUP_RestApiId" {
  value = module.restApi.restApiId
}

output "AGRAMVKUP_RestApiName" {
  value = module.restApi.restApiName
}

output "AGRAMVKUP_RestApiRootResourceId" {
  value = module.restApi.restApiRootResourceId
}
