...
modules = [
    {
        "paths": {
            ...
            "destination_path": "../projects/_DCPO_distributionCachePolicyOrp",
        },
        "previous_variable_prefix": "distribution",
        "new_variable_prefix": "DCPO_Distribution",
    ...
    },
    {
        ...
        "new_variable_prefix": "DCPO_CachePolicy",
    ...
    },
    {
        ...
        "previous_variable_prefix": "orp",
        "new_variable_prefix": "DCPO_OrpDataSource",
