...
module "snsTopicSubscription" {
  ...
  snsTopicSubscriptionFilterPolicy                 = var.TWS_SnsTopicSubscriptionFilterPolicy != null ? jsonencode(var.TWS_SnsTopicSubscriptionFilterPolicy) : null
  ...
  snsTopicSubscriptionRedrivePolicy                = var.TWS_SnsTopicSubscriptionRedrivePolicy != null ? jsonencode(var.TWS_SnsTopicSubscriptionRedrivePolicy) : null
  snsTopicSubscriptionReplayPolicy                 = var.TWS_SnsTopicSubscriptionReplayPolicy != null ? jsonencode(var.TWS_SnsTopicSubscriptionReplayPolicy) : null
}
