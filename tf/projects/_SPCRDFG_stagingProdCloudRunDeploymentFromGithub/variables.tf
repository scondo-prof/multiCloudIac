...
variable "SPCRDFG_CloudBuildTriggerServiceAccountsRoleId" {
  type = string
}
...
variable "SPCRDFG_CloudBuildTriggerYamlPath" {
  type    = string
...
variable "SPCRDFG_CloudBuildTriggerBranchName" {
  type    = string
  default = "main"
}
...
variable "SPCRDFG_CloudBuildTriggerBucketName" {
  type = string
}
