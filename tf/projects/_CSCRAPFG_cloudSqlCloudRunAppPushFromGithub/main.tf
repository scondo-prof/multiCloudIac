...
module "CRDPFG" {
  ...
  gcpProjectId                                               = var.gcpProjectId
  gcpRegion                                                  = var.gcpRegion
  CRDPFG_SWSV_Cloudbuild_SecretReplicationAuto               = var.CSCRAPFG_CRDPFG_SWSV_Cloudbuild_SecretReplicationAuto
  CRDPFG_SWSV_Cloudbuild_SecretReplicationUserManaged        = var.CSCRAPFG_CRDPFG_SWSV_Cloudbuild_SecretReplicationUserManaged
  resourceName                                               = var.resourceName
  projectName                                                = var.projectName
  deployedDate                                               = var.deployedDate
  createdBy                                                  = var.createdBy
  tfModule                                                   = var.tfModule
  additionalTags                                             = var.additionalTags
  CRDPFG_SWSV_Cloudbuild_SecretAnnotations                   = var.CSCRAPFG_CRDPFG_SWSV_Cloudbuild_SecretAnnotations
  CRDPFG_SWSV_Cloudbuild_SecretVersionAliases                = var.CSCRAPFG_CRDPFG_SWSV_Cloudbuild_SecretVersionAliases
  CRDPFG_SWSV_Cloudbuild_SecretVersionDestroyTtl             = var.CSCRAPFG_CRDPFG_SWSV_Cloudbuild_SecretVersionDestroyTtl
  CRDPFG_SWSV_Cloudbuild_SecretTopics                        = var.CSCRAPFG_CRDPFG_SWSV_Cloudbuild_SecretTopics
  CRDPFG_SWSV_Cloudbuild_SecretExpireTime                    = var.CSCRAPFG_CRDPFG_SWSV_Cloudbuild_SecretExpireTime
  CRDPFG_SWSV_Cloudbuild_SecretTtl                           = var.CSCRAPFG_CRDPFG_SWSV_Cloudbuild_SecretTtl
  CRDPFG_SWSV_Cloudbuild_SecretRotation                      = var.CSCRAPFG_CRDPFG_SWSV_Cloudbuild_SecretRotation
  CRDPFG_SWSV_Cloudbuild_SecretVersionObjects                = var.CSCRAPFG_CRDPFG_SWSV_Cloudbuild_SecretVersionObjects
  CRDPFG_ServiceAccountDisabled                              = var.CSCRAPFG_CRDPFG_ServiceAccountDisabled
  CRDPFG_ServiceAccountCreateIgnoreAlreadyExists             = var.CSCRAPFG_CRDPFG_ServiceAccountCreateIgnoreAlreadyExists
  CRDPFG_ServiceAccountRoleId                                = var.CSCRAPFG_CRDPFG_ServiceAccountRoleId
  CRDPFG_ServiceAccountRoleStage                             = var.CSCRAPFG_CRDPFG_ServiceAccountRoleStage
  ...
  CRDPFG_CloudRunLogsAlertPolicyEnabled                      = var.CSCRAPFG_CRDPFG_CloudRunLogsAlertPolicyEnabled
  CRDPFG_CloudRunInfraAlertPolicyNotificationChannels        = var.CSCRAPFG_CRDPFG_CloudRunInfraAlertPolicyNotificationChannels
  CRDPFG_CloudRunLogsAlertPolicyAlertStrategy                = var.CSCRAPFG_CRDPFG_CloudRunLogsAlertPolicyAlertStrategy
  CRDPFG_CloudRunLogsAlertPolicySeverity                     = var.CSCRAPFG_CRDPFG_CloudRunLogsAlertPolicySeverity
  CRDPFG_CloudRunLogsAlertPolicyDocumentation                = var.CSCRAPFG_CRDPFG_CloudRunLogsAlertPolicyDocumentation
  ...
  CRDPFG_CloudRunMemAlertPolicyEnabled                       = var.CSCRAPFG_CRDPFG_CloudRunMemAlertPolicyEnabled
  CRDPFG_CloudRunMemAlertPolicyAlertStrategy                 = var.CSCRAPFG_CRDPFG_CloudRunMemAlertPolicyAlertStrategy
  CRDPFG_CloudRunMemAlertPolicySeverity                      = var.CSCRAPFG_CRDPFG_CloudRunMemAlertPolicySeverity
  CRDPFG_CloudRunMemAlertPolicyDocumentation                 = var.CSCRAPFG_CRDPFG_CloudRunMemAlertPolicyDocumentation
  ...
  CRDPFG_CloudRunCpuAlertPolicyEnabled                       = var.CSCRAPFG_CRDPFG_CloudRunCpuAlertPolicyEnabled
  CRDPFG_CloudRunCpuAlertPolicyAlertStrategy                 = var.CSCRAPFG_CRDPFG_CloudRunCpuAlertPolicyAlertStrategy
  CRDPFG_CloudRunCpuAlertPolicySeverity                      = var.CSCRAPFG_CRDPFG_CloudRunCpuAlertPolicySeverity
  CRDPFG_CloudRunCpuAlertPolicyDocumentation                 = var.CSCRAPFG_CRDPFG_CloudRunCpuAlertPolicyDocumentation
}
