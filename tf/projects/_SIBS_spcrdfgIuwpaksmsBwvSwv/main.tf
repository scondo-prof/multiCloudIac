...
module "SPCRDFG" {
  ...
  SPCRDFG_CRDPRFG_SWSV_SecretVersionObjects                                = var.SIBS_SPCRDFG_CRDPRFG_SWSV_SecretVersionObjects
  ...
  SPCRDFG_CRDPFG_SWSV_Cloudbuild_SecretVersionObjects                      = var.SIBS_SPCRDFG_CRDPFG_SWSV_Cloudbuild_SecretVersionObjects
...
module "IUWPAKSMS" {
  ...
  IUWPAKSMS_UWP_IamPolicyDocumentStatements = var.SIBS_IUWPAKSMS_UWP_IamPolicyDocumentStatements
